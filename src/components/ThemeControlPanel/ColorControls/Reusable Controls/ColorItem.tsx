...
const ColorItem: React.FC<ColorItemProps> = ({
  ...
  return (
    <Card w={'100%'} withBorder bd={`1px solid ${theme.getColor(name)?.[2]}`} bg={theme.getColor(name)?.[0]} padding="xs" radius="sm">
      <Stack gap="m">
          ...
          <Group w={'75%'} wrap="nowrap">
            {type === 'theme' ? (
              ...
              <Tooltip label={description}>
                <ActionIcon c={theme.getColor(name)?.[8]} size={12} radius={100} bd={'1px solid'} variant="outline" >
