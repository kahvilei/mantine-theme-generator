...
const ColorPalette: React.FC<ColorPaletteProps> = ({ theme, updateTheme, colorKeyColors, setColorKeyColors }) => {
    ...
    return (
        <Card withBorder padding="lg">
                    ...
                    <Popover key={colorName} withArrow position="bottom">
                        ...
                        <Popover.Dropdown>
                            <Stack>
                                ...
                                />
                                <Button onClick={() => openShadeModal(colorName)}>
                                    Fine-tune Shades
                                </Button>
                            </Stack>
                        </Popover.Dropdown>
            ...
            >
                <Stack>
                    {theme.colors && theme.colors[currentEditingColor] && 
