              ...
              <Stack gap="md">
                ...
                <Paper p="md">
                  <Stack>
                    ...
                    <Box>
                      <NavLink label="Dashboard" leftSection={<IconDashboard size={16} />} active />
                  ...
                  <Stack>
                    ...
                    <Accordion>
                      <Accordion.Item value="item-1">
                        ...
                        <Accordion.Panel>
                          Mantine is a React component library with a focus on usability,
                      ...
                      <Accordion.Item value="item-2">
                        ...
                        <Accordion.Panel>
                          Mantine components can be customized with global theme and inline styles.
                        </Accordion.Panel>
                      </Accordion.Item>
                    </Accordion>
                  </Stack>
